...
It should be noted that the powerDAC-S can be used to drive headphones that require more power than the smaller "R" model can provided - my previous review adressed headphone listening with the powerDAC-R and I chose to focus here on the powerDAC-S' use with speakers, which is my preferred listening mode.
